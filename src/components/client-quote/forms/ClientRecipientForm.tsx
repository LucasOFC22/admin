...
interface ClientRecipientFormProps {
...
export function ClientRecipientForm({ form }: ClientRecipientFormProps) {
  ...
  const handleCNPJBlur = async (cnpj: string) => {
    ...
    if (cleanCNPJ.length === 14) {
      ...
      if (data) {
        form.setValue("recipient.name", data.alias || data.company.name);
        form.setValue("recipient.address.zipcode", formatCEP(data.address.zip));
        form.setValue("recipient.address.street", data.address.street);
        form.setValue("recipient.address.number", data.address.number);
        form.setValue("recipient.address.complement", data.address.details || "");
        form.setValue("recipient.address.neighborhood", data.address.district);
        form.setValue("recipient.address.city", data.address.city);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <FormField
            control={form.control}
            name="recipient.address.neighborhood"
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <FloatingInput
