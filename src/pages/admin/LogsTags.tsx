...
import { LogTag } from '@/types/allLogs';
...
const LogsTags = () => {
  ...
  const { data, isLoading, refetch } = useQuery({
    queryKey: ['logs-tags', filters, currentPage, pageSize],
    queryFn: async () => {
      ...
      return { logs: data as LogTag[], total: count || 0 };
    }
  });
  ...
  return (
    <PermissionGuard
      permissions="admin.logs-tags.visualizar"
      showMessage={true}
    >
      <div className="space-y-6 p-6">
        <LogsHeader
          title="Logs de Tags"
          description="Histórico de alterações em tags"
